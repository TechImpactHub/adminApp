...
const AddStoreBusiness = (props) => {
    ...
    const [formState, setFormState] = useState({
      ...
      partner: '',
      partnerUuid: '',
      nationalId: props.location.state.query.partner.partner.nationalId,
      email: '',
      username: '',
      firstName: '',
      lastName: '',
                    ...
                    <CardBody>
                      ...
                      <Form>
                          <Row>
                              ...
                              <Input
                                        value={props.location.store ? props.location.store.node.name : formState.storeName }
                                        onChange={(e) =>
                                            setFormState({
                                            ...formState,
                        ...
                        <Col className="pr-md-1" md="6">
                              ...
                              <Input 
                                        value={props.location.store ? props.location.store.node.subcategory : formState.subcategory}
                                        onChange={(e) =>
                                            setFormState({
                                            ...formState,
...
export default AddStoreBusiness;
